...
public class TravelLocationsAdapter extends RecyclerView.Adapter<TravelLocationsAdapter.TravelLocationViewHolder> {
    ...
    static class TravelLocationViewHolder extends RecyclerView.ViewHolder {
        ...
        private TextView textTitle, textLocation, textStarRatng;
        ...
        public TravelLocationViewHolder(@NonNull View itemView) {
            ...
            textStarRatng = itemView.findViewById(R.id.textStarRating);
        }
        ...
        void setLocationData(TravelLocation travelLocation){
            ...
            textStarRatng.setText(String.valueOf(travelLocation.starRating));
        }
    }
}
